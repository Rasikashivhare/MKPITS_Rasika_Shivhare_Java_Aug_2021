...
// System.out.println("successfully connected");
                    ...
                    String qr="insert into users(username,pwd) values('"+t1.getText()+"','"+t2.getText()+"') ";
...
// System.out.println("successfully connected");
                            Statement stmt=con.createStatement();
                    String qr="update users set pwd = '"+t2.getText()+"' where username = '"+t1.getText()+"' ";
                    stmt.executeUpdate(qr);
                    con.close();
