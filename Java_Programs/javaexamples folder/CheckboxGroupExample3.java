...
public class CheckboxGroupExample3
{
Label l1,l2,l3,l4;
TextField tf;
Button b1;
...
Checkbox checkBox22 = newCheckbox("Female", cbg1, true);
...
//for checkboxStringBuilder sb=newStringBuilder();
sb.append("course selected :");
if(checkBox1.getState()==true) {
sb.append(" c++");
// l12.setText("checkbox 1 ischecked");
}
if (checkBox2.getState()==true) {
sb.append(" java");

//l12.setText("checkbox 2 ischecked");
}
